...
def init_db():
    ...
    cursor.execute("CREATE TABLE IF NOT EXISTS vendors (id TEXT PRIMARY KEY NOT NULL, company_name TEXT NOT NULL, contact_name TEXT, email TEXT, phone TEXT, billing_address TEXT, billing_city TEXT, billing_state TEXT, billing_zip_code TEXT, shipping_address TEXT, shipping_city TEXT, shipping_state TEXT, shipping_zip_code TEXT, created_at TEXT DEFAULT CURRENT_TIMESTAMP, updated_at TEXT DEFAULT CURRENT_TIMESTAMP);")
